...
export default function ColorPicker({
  ...
  return (
    <div
      className="LexicalEditor_color-picker-wrapper"
      style={{width: WIDTH}}
      ref={innerDivRef}>
      <TextInput label="Hex" onChange={onSetHex} value={inputColor} />
      <div className="LexicalEditor_color-picker-basic-color">
      ...
      <MoveWrapper
        className="LexicalEditor_color-picker-saturation"
        style={{backgroundColor: `hsl(${selfColor.hsv.h}, 100%, 50%)`}}
        onChange={onMoveSaturation}>
        <div
          className="LexicalEditor_color-picker-saturation_cursor"
          style={{
      ...
      <MoveWrapper className="LexicalEditor_color-picker-hue" onChange={onMoveHue}>
        <div
          className="LexicalEditor_color-picker-hue_cursor"
          style={{
      ...
      <div
        className="LexicalEditor_color-picker-color"
